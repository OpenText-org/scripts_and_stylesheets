    ...
    function addComponent(node)
    {
		...
		// HACK TO MAKE OLD JS WORK WITH MODERN BROWSERS
		node = node.toElement;
...
component.parentNode.parentNode.parentNode.parentNode.parentNode;
	...
	console.log(thisN)
        ...
        if (move)
        {
              if (thisN.id)
              {
                  thisN.getElementsByTagName("tr").item(0).appendChild(moveNode.firstChild);
                  move = false;
        ...
        if (thisN.style.background == "red")
        {

           delete selected[this.id];
           if (thisN.tagName == "SPAN")
           {

              thisN.style.background = "white";
           }
           else
           {

              thisN.style.background = "pink";
           }
        ...
        {
           thisN.style.background = "red";
           // selected.appendChild(this);
           selected[thisN.id] = thisN;
